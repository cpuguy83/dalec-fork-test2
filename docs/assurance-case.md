...
- **Claim C3.1:** Build orchestration is declaratively defined and executed via BuildKit using configuration checked into the repository, and the automated release workflow applies the same configuration when publishing official images from immutable releases.
  *Evidence:* [ARCHITECTURE.md#build-orchestration-flow](../ARCHITECTURE.md#build-orchestration-flow), [ARCHITECTURE.md#runtime-components](../ARCHITECTURE.md#runtime-components), [.github/workflows/create-release.yml](../.github/workflows/create-release.yml), [.github/workflows/release.yml](../.github/workflows/release.yml).
...
- **Claim C3.3:** Release metadata is reviewed through pull requests, release tags are signed with Sigstore keyless signing before immutable GitHub Releases are published, and release image workflows build, push, sign, and attest frontend and worker images through GitHub Actions using BuildKit and GitHub OIDC.
  *Evidence:* [.github/workflows/create-release.yml](../.github/workflows/create-release.yml), [.github/workflows/release.yml](../.github/workflows/release.yml), [.github/workflows/frontend-image.yml](../.github/workflows/frontend-image.yml), [.github/workflows/worker-images.yml](../.github/workflows/worker-images.yml), [GOVERNANCE.md#branch-protection](../GOVERNANCE.md#branch-protection).
...
| C3.1 | Declarative BuildKit orchestration | [ARCHITECTURE.md#build-orchestration-flow](../ARCHITECTURE.md#build-orchestration-flow), [ARCHITECTURE.md#runtime-components](../ARCHITECTURE.md#runtime-components), [.github/workflows/create-release.yml](../.github/workflows/create-release.yml), [.github/workflows/release.yml](../.github/workflows/release.yml) |
| C3.2 | Generation validation controls | [.github/workflows/ci.yml](../.github/workflows/ci.yml), [spec.go](../spec.go) |
| C3.3 | Release pipeline controls | [.github/workflows/create-release.yml](../.github/workflows/create-release.yml), [.github/workflows/release.yml](../.github/workflows/release.yml), [.github/workflows/frontend-image.yml](../.github/workflows/frontend-image.yml), [.github/workflows/worker-images.yml](../.github/workflows/worker-images.yml), [GOVERNANCE.md#branch-protection](../GOVERNANCE.md#branch-protection) |
